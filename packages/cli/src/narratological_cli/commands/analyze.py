...
def analyze_script(
    script_path: Annotated[
        Path,
        typer.Argument(help="Path to script file (txt, pdf, fdx)", exists=True, file_okay=True, dir_okay=False, readable=True),
    ],
    framework: Annotated[
        str | None,
...
def analyze_protocol(
    script_path: Annotated[
        Path,
        typer.Argument(help="Path to script file (txt, pdf, fountain, fdx)", exists=True, file_okay=True, dir_okay=False, readable=True),
    ],
    level: Annotated[
        str,
